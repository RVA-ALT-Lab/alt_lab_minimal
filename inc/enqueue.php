...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_script( 'iframe-child-resize', get_template_directory_uri() . '/js/set-iframe-height-child-min.js', array(), false, true);//iframe resizer from https://github.com/FaiblUG/setIframeHeight
